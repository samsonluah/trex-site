...
// Make sure to set your STRIPE_SECRET_KEY using:
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/stripe-checkout' \
    ...
    --data '{"line_items":[{"price":"price_1234","quantity":1}],"success_url":"http://localhost:3000/success","cancel_url":"http://localhost:3000/cancel"}'
